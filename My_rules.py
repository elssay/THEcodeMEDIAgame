...
tk.title('Нажмите Enter чтобы начать игру')
#lbl = Label(tk, text="Привет")  
...
class Ball:
    ...
    def __init__(self, canvas, paddle, score, color):
        ...
        self.id = canvas.create_oval(10,10, 95, 95, fill='violet')
...
class Paddle:
    ...
    def __init__(self, canvas, color):
        ...
        self.id = canvas.create_rectangle(0, 0, 50, 7, fill='green')
